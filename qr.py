...
frame = Frame(cp, bg='#4feadb')
frame.pack(expand=True)

#------------------ENTER THE TEXT OR URL------------------

Label(frame, text='Enter the Text or URL : ', font=('Chaucer', 16),
      bg='#4feadb').grid(row=0, column=0, sticky='w')
...
Label(frame, text='File Name(Save As) :  ', font=('Chaucer', 16),
      bg='#4feadb').grid(row=1, column=0, sticky='w')
